...
class ResultScreen extends GetView<QuestionsController> {
  ...
  Widget build(BuildContext context) {
    ...
    Color _textColor = isDark ? tOnBoardingPage3Color : primaryColorLigth;
    return Scaffold(
      ...
      body: BackgroundDecoration(
          child: Column(
            children: [
                        ...
                        Padding(
                          ...
                          child: Text('Congratulazioni',
                            style: headerText.copyWith(
                                color: isDark ? tOnBoardingPage3Color : primaryColorLigth,
                            ),
                          ),
                        ),
              ...
              ColoredBox(
                color: isDark ? const Color(0xff232f46)
